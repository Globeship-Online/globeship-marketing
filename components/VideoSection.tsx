        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr,0.9fr] lg:items-center">
          ...
          <div className="group relative aspect-video overflow-hidden rounded-2xl border border-orange-500/25 bg-black shadow-xl shadow-black/60 transition-all duration-300 hover:border-orange-400 hover:shadow-[0_0_60px_rgba(249,115,22,0.25)]">
            ...
            <div className="pointer-events-none absolute inset-0 z-10 flex items-center justify-center">
              <div className="flex h-16 w-16 items-center justify-center rounded-full bg-black/70 border border-orange-400/60 shadow-lg shadow-orange-500/30 transition-all duration-300 group-hover:scale-110 group-hover:bg-black/80">
                <svg
            ...
            <iframe
              ...
              src="https://www.youtube.com/watch?v=ik0jbnp2ihY"
